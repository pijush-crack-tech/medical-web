            ...
            <div>
              {userBatch && userBatch.batch_id == 0 ? (
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all"
                >
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-blue-100 text-sm">Start your learning journey today</p>
                    </div>
                  </div>
                </motion.button>
              ) : (
